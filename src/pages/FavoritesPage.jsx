...
const FavoritesPage = () => {
  ...
  if (localFavorites.length === 0) {
    return (
      <div className="mx-5 min-[1000px]:mx-10 text-xl py-10 text-gray-500 min-h-[75vh] min-h-dvh-75">
  ...
  return (
    <div className="w-full bg-[#F7FAFC]">
      <div className="px-6 mx-auto max-w-[1404px] min-[1000px]:px-10 bg-[#F7FAFC] p-4 min-h-[100vh] min-h-dvh-100">
        <div className="">
