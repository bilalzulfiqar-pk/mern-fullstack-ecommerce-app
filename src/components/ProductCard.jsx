...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link to={`/product/${product._id}`}>
      <div
        className={`flex group h-full border relative border-[#E0E0E0] rounded-lg p-4 max-[680px]:flex-col shadow-xs items-center space-x-4 w-full transition-all duration-300 bg-white ${
