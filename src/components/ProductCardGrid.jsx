...
const ProductCardGrid = ({ product }) => {
  ...
  return (
    <div
      ...
      className={`border group h-full rounded-lg border-[#E0E0E0] cursor-pointer flex flex-col bg-white transition-all overflow-hidden duration-300 ${
    ...
    >
      ...
      <div className="relative">
        <img
          ...
          className="w-full aspect-square h-full object-cover rounded-md group-hover:scale-103 transition-transform duration-300 ease-in-out"
        />
      </div>

      {/* Product Details */}
      <div className="mt-3 h-fit relative p-4 border-t border-[#E0E0E0]">
        {/* Price */}
